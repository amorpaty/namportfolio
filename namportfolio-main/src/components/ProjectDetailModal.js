...
function ProjectDetailModal({ project, onClose }) {
    ...
    const openImageZoomed = (imageUrl) => setZoomedImage(imageUrl);
                            ...
                            {project.imageList.map((image, index) => (
                                <SwiperSlide key={index}>
                                    <img
                                        ...
                                        onClick={() => openImageZoomed(image, true)}
            ...
            {zoomedImage && (
                ...
                >
                    <img
                        src={zoomedImage}
                        alt="확대 이미지"
                        className="w-full h-full object-contain cursor-zoom-out transition-all duration-300"
                    />
                </div>
            )}
        </>
